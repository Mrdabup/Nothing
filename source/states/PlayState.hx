...
class PlayState extends MusicBeatState
{
	...
	function set_health(value:Float):Float // You can alter how icon animations work here
	{
		...
		if (ClientPrefs.data.disSomeIcons != true) 
		{
		...
		return health;
		//How does this work? If the client (user in this case) does not enable to revert the icons, then we can use the winning icons as default
		//And do a series of checks using healthBar.percent instead of the new function (as it breaks for some reason) -TOJG
	}
